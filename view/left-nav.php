                        ...
                        if ($_GET["action"] == "compte") {
                            echo '
                                    <li class="border-l-[#FF742F] border-y py-4 border-l-8">
                                        <a class="flex items-center" href="index.php?action=compte">
                                    ...
                                    <li class="border-b-gray-400 border-b py-4 hover:border-l-[#FF742F] border-l-8">
                                        <a class="flex items-center" href="index.php?action=modif-compte">
                                    ...
                                    <li class="border-b-gray-400 border-b py-4 hover:border-l-[#FF742F] border-l-8">
                                        <a href= "index.php?action=historique-achat" class="flex items-center">
                                            <svg class="w-5 ml-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                                            </svg>
                                            <h1 class="mx-6 my-4 text-xs font-bold uppercase tracking-widest">Historique des achats</h1>
                                        </a>
                                    </li>
                                    <li class="border-b-gray-400 border-b py-4 hover:border-l-[#FF742F] border-l-8">
                                    ...
                                    ';
                        } elseif ($_GET["action"] == "modif-info-client") {
                            echo '
                                    <li class="border-b-gray-400 border-b hover:border-l-[#FF742F] border-y py-4 border-l-8">
                                        <a class="flex items-center" href="index.php?action=compte">
                                            <svg class="w-5 ml-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                            </svg>
                                    ...
                                    <li class="border-b-gray-400 border-b py-4 border-l-[#FF742F] border-l-8">
                                        <a class="flex items-center" href="index.php?action=modif-compte">
                                            <svg class="w-5 ml-5 hover:text-orange-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                                            </svg>
                                    ...
                                    ';
                        } elseif ($_GET["action"] == "modif-compte") {
                            echo '
                                    ...
                                    <li class="border-l-[#FF742F] border-b py-4 border-l-8">
                                        <a class="flex items-center" href="index.php?action=modif-compte">
                                            <svg class="w-5 ml-5 hover:text-orange-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                                            </svg>
                                    ...
                                    ';
                        } elseif ($_GET["action"] == "historique-achat") {
                            echo '
                                    <li class="border-b-gray-400 hover:border-l-[#FF742F] border-y py-4 border-l-8">
                                        <a class="flex items-center" href="index.php?action=compte">
                                            <svg class="w-5 ml-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
