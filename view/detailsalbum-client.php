...
<main>
    ...
    <div class=" grid grid-cols-3 mt-10 mb-4 ml-8">
        <img class="h-44 justify-self-center" src="pictures/OrangeCD.png">
        <section class="col-span-2">
            <ul class="grid grid-rows-3 gap-4 items-center mt-4">
                <li class="text-4xl font-bold text-[#FF742F]">
                    <h1><?= $model[0][0]->nom_album; ?></h1>
                </li>
                <li class="text-lg mt-8">Interprète : <?= $model[0][0]->nom_artiste; ?></li>
                <li class="text-lg">Genre musical : <?= $model[0][0]->genre; ?></li>
            </ul>
        </section>
    </div>
